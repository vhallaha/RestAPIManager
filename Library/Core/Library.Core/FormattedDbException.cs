...
{
    public class FormattedDbException : Exception
    {
            ...
            get
            {
                ...
                if (innerException != null)
                {
                    ...
                    foreach (var eve in innerException.EntityValidationErrors)
                    {
                        ...
                        {
                            sb.AppendLine($"-- Property: \"{ve.PropertyName}\", Value: \"{eve.Entry.CurrentValues.GetValue<object>(ve.PropertyName)}\", Error: \"{2}\"");
                        }
                    }
                    sb.AppendLine();
